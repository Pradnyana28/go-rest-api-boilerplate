...
func New(svc user.Service, logger rest.Logger) *LogService {
	return &LogService{
		Service: svc,
		logger:  logger,
	}
...
// Create logging
func (ls *LogService) Create(c echo.Context, req rest.User) (resp *rest.User, err error) {
...
// List logging
func (ls *LogService) List(c echo.Context, req *rest.Pagination) (resp []rest.User, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
...
// View logging
func (ls *LogService) View(c echo.Context, req int) (resp *rest.User, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
...
// Update logging
func (ls *LogService) Update(c echo.Context, req *user.Update) (resp *rest.User, err error) {
	defer func(begin time.Time) {
		ls.logger.Log(
			c,
